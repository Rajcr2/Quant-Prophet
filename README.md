# CSV-Based Quantitative Market Research & Forecasting

## Introduction

My this project focuses on quantitative time-series analysis and forecasting using structured financial datasets with an emphasis on understanding trends, seasonality and volatility in stock price behavior.
Using Prophet, the workflow applies forecasting techniques to historical data to study future trend patterns over monthly and yearly periods, while maintaining a strong focus on data consistency, interpretability, and result evaluation.
...
3. **Forecast evaluation using error metrics (RMSE, MAPE) to assess trend stability and consistency**

### Objectives

The primary goal of this project is to support quantitative research by:

1. Analyzing historical data to study trend behavior, seasonality, and volatility
2. Producing realistic and interpretable forecasts for research purposes
3. Using quantitative metrics and visual outputs to present numerical findings and explain research insights clearly
...
Based on error metrics and visual analysis, this project highlights how clean, well-validated data can be analyzed to identify trend behavior and stability. The focus remains on accuracy, consistency and clear presentation of results making the workflow suitable for quantitative market research and reporting.
